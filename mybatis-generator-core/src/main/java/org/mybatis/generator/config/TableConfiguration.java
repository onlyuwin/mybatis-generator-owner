...
public class TableConfiguration extends PropertyHolder {
    ...
    private boolean removeByPrimaryKeyStatementEnabled;//onlyuwin新增逻辑删除方法
    ...
    public TableConfiguration(Context context) {
        ...
        //onlyuwin新增,默认不生成
        removeByPrimaryKeyStatementEnabled = false;
    ...
    //onlyuwin新增
    public boolean isRemoveByPrimaryKeyStatementEnabled() {
        return removeByPrimaryKeyStatementEnabled;
    }

    //onlyuwin新增
    public void setRemoveByPrimaryKeyStatementEnabled(
            boolean removeByPrimaryKeyStatementEnabled) {
        this.removeByPrimaryKeyStatementEnabled = removeByPrimaryKeyStatementEnabled;
    }
    ...
    public boolean areAnyStatementsEnabled() {
        return selectByExampleStatementEnabled
                ...
                || removeByPrimaryKeyStatementEnabled
    ...
    public XmlElement toXmlElement() {
        ...
        //onlyuwin新增
        if (!removeByPrimaryKeyStatementEnabled) {
            xmlElement.addAttribute(new Attribute(
                    "enableRemoveByPrimaryKey", "false")); //$NON-NLS-1$ //$NON-NLS-2$
        }
