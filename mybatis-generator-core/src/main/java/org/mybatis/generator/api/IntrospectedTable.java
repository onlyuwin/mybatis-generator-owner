...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        //onlyuwin新增
        ATTR_REMOVE_BY_PRIMARY_KEY_STATEMENT_ID,
    }
    ...
    public void initialize() {
        calculateJavaClientAttributes();//tip: mapper
        calculateModelAttributes();//tip:po
        calculateExampleAttributes();//onlyuwin 新增example资源位置生成~
        calculateXmlAttributes();//tip:xml
    ...
    protected void calculateXmlAttributes() {
        ...
        setRemoveByPrimaryKeyStatementId("removeByPrimaryKey");//onlyuwin
    ...
    public void setRemoveByPrimaryKeyStatementId(String s) {
        internalAttributes.put(
                InternalAttribute.ATTR_REMOVE_BY_PRIMARY_KEY_STATEMENT_ID,
                s);
    }
    ...
    public String getRemoveByPrimaryKeyStatementId() {
        return internalAttributes
                .get(InternalAttribute.ATTR_REMOVE_BY_PRIMARY_KEY_STATEMENT_ID);
    }
    ...
    protected String calculateJavaModelPackage() {
        //tip: 获取Context上下文中已经缓存了javaModelGenerator标签属性信息的JavaModelGeneratorConfiguration解析器
        JavaModelGeneratorConfiguration config = context
                .getJavaModelGeneratorConfiguration();

        StringBuilder sb = new StringBuilder();
        //tip: javaModelGenerator 标签中 targetPackage 属性的值
        sb.append(config.getTargetPackage());
    ...
    //onlyuwin 同 calculateJavaModelPackage 方法新增Example 解析
    ...
    protected void calculateModelAttributes() {
        //tip: 读取的是javaModelGenerator 标签的包路径
        String pakkage = calculateJavaModelPackage();
        //tip: 拼装全限定名，会影响生成类的位置
        StringBuilder sb = new StringBuilder();
        sb.append(pakkage);
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
    ...
    //onlyuwin新增 同calculateModelAttributes 方法新增Example解析
