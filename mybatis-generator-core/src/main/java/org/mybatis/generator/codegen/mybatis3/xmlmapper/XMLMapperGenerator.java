...
import com.only.generator.extplugin.xmlmapper.elements.RemoveByPrimaryKeyElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        //onlyuwin 新增逻辑删除
        addRemoveByPrimaryKeyElement(answer);
    ...
    //onlyuwin新增根据id进行逻辑删除2018-11-16 0:03
    protected void addRemoveByPrimaryKeyElement(XmlElement parentElement) {
        if (introspectedTable.getRules().generateRemoveByPrimaryKey()) {
            AbstractXmlElementGenerator elementGenerator = new RemoveByPrimaryKeyElementGenerator(false);
            initializeAndExecuteGenerator(elementGenerator, parentElement);
        }
    }
